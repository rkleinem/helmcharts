...
{{- list $img (default .Chart.AppVersion .Values.deployment.tag) | join ":" }}
{{- end }}
...
{{- default (include "auditor-collector.fullname" .) .Values.serviceAccount.nameOverride }}
{{- end }}

{{- define "auditor-collector.clusterRoleName" -}}
{{- default (include "auditor-collector.fullname" .) .Values.clusterRole.nameOverride }}
{{- end }}
